...
class Controller(private val service: Service,
                    private val validator: BaseValidator, private val customService: DeliveryClientService, private val restTemplateClient: RestTemplateClient) {
...
//        service.save(model)
        restTemplateClient.postForm<Model>()
        return ResponseEntity.ok(ServiceResponse("200",
